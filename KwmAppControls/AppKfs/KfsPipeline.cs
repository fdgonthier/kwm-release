...
namespace kwm.KwmAppControls.AppKfs
{
    ...
    public class KfsPipeline
    {
        ...
        private void InitScanStage()
        {
            ...
            if (startFlag)
            {
                // Scan started. Stall until the results are received.
                // Clear the sync flag here, we don't want to keep syncing on
                // failure. The sync flag will be set on success.
        ...
        private void TransferStage()
        {
            ...
            // until the event had the chance to be applied and the UI view to
