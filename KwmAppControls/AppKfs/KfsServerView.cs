...
namespace kwm.KwmAppControls.AppKfs
{
    ...
    public class KfsServerDirectory : KfsServerObject
    {
        ...
        /// </summary>
        public SortedDictionary<String, KfsServerObject> ChildTree = new SortedDictionary<String, KfsServerObject>(KfsPath.Comparer);
    ...
    public class KfsServerFileUploader
    {
        ...
        /// </summary>
        public SortedDictionary<UInt64, KfsServerFile> FileTree = new SortedDictionary<UInt64, KfsServerFile>();
    ...
    public class KfsServerView
    {
        ...
        /// </summary>
        public SortedDictionary<UInt64, KfsServerObject> InodeTree = new SortedDictionary<UInt64, KfsServerObject>();

        /// <summary>
        /// Tree mapping commit IDs to KfsServerFileUploader.
        /// </summary>
        public SortedDictionary<UInt64, KfsServerFileUploader> UploaderTree = new SortedDictionary<UInt64, KfsServerFileUploader>();
