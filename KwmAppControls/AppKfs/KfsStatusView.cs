...
namespace kwm.KwmAppControls.AppKfs
{
    ...
    public class KfsStatusPath
    {
        ...
        /// </summary>
        public SortedDictionary<String, KfsStatusPath> ChildTree = new SortedDictionary<String, KfsStatusPath>(KfsPath.Comparer);
    ...
    public class KfsStatusView
    {
        ...
        /// a delimiter.
        /// </summary>
        public SortedDictionary<String, KfsStatusPath> PathTree = new SortedDictionary<String, KfsStatusPath>(KfsPath.Comparer);
        ...
        public void UpdateView()
        {
            ...
            // Find the entries that are present in the local view. The entries
            // may or may not be present in the server view.
