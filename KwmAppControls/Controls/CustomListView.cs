...
namespace kwm.Utils
{
    ...
    class CustomListView : ListView
    {
        ...
        public CustomListView() : base()
        {
            ...
            // This eliminates the flicker on resize.
        ...
        {
            // Optimization to eliminate flicker. Not strictly necessary
            // because of the calls to SetStyle above but erasing the background
            // is useless anyway.
            if (m.Msg == 0x14) return; // WM_ERASEBKNG
