...
namespace kwm.KwmAppControls
{
    ...
    public partial class BaseAppControl : UserControl
    {
        ...
        /// <summary>
        /// Notify the source application of the change.
        /// </summary>
        public void HandleOnKwmFocusChanged(bool isFocused)
        {
            if (m_srcApp != null) m_srcApp.HandleOnKwmFocusChanged(isFocused);
        }
