...
namespace kwm.Utils
{
    public sealed class KwmApplicationSettings : ApplicationSettingsBase
    {
        ...
        /// <summary>
        /// Default ThinKfs flag set to workspaces created by this kwm.
        /// </summary>
        [UserScopedSettingAttribute()]
        [SettingsManageabilityAttribute(SettingsManageability.Roaming)]
        [DefaultSettingValueAttribute("true")]
        ...
        {
            get { return (bool)this["NewKwsThinKfsDefaultFlag"]; }
            set
            {
                this["NewKwsThinKfsDefaultFlag"] = value;
            }
        }

        /// <summary>
        /// Tells the initial "Advanced view" behavior in the main form.
        /// 0 -> auto, 1 -> always show
        /// </summary>
        [UserScopedSettingAttribute()]
        [SettingsManageabilityAttribute(SettingsManageability.Roaming)]
        [DefaultSettingValueAttribute("false")]
        public bool ShowMainFormAdvancedView
        {
            get { return (bool)this["ShowMainFormAdvancedView"]; }
            set
            {
                this["ShowMainFormAdvancedView"] = value;
            }
        }
