...
namespace kwm.KwmAppControls
{
    ...
    public interface IAppHelper
    {
        ...
        /// may be returned.
        /// </summary>
        KwsUser GetUserByID(UInt32 ID);

        /// <summary>
        /// Return the non-virtual user having the ID specified, if any.
        /// </summary>
        KwsUser GetNonVirtualUserByID(UInt32 ID);
    ...
    public class OnKwmFocusChanged : EventArgs
    {
        ...
        public OnKwmFocusChanged(bool isFocused)
        {
    ...
    public abstract class KwsApp
    {
        ...
        /// <summary>
        /// Handle the focus change. Only used by the KFS application
        /// for now.
        /// </summary>
        public virtual void HandleOnKwmFocusChanged(bool isFocused)
        {
        }
    }
    ...
    /// <summary>
    /// Display a generic message box with an OK button.
    /// </summary>
    public class MiscGuiExecRequest : GuiExecRequest
    {
        private MessageBoxIcon m_icon;
        private String m_msg;
        private String m_caption;

        public MiscGuiExecRequest(String msg, String caption, MessageBoxIcon icon)
        {
            m_msg = msg;
            m_icon = icon;
            m_caption = caption;
        ...
        {
            MessageBox.Show(m_msg, m_caption, MessageBoxButtons.OK, m_icon);
        }
    }

    public class LicenseRestrictionGer : GuiExecRequest
    {
        private String m_msg;
        private bool m_showUpgradeAccount;

        public LicenseRestrictionGer(String msg, bool showUpgradeAccount)
        {
            m_msg = msg;
            m_showUpgradeAccount = showUpgradeAccount;
        }
