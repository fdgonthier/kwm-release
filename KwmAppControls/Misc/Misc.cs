...
namespace kwm.Utils
{
    ...
    public interface IUiBroker
    {
        ...
        void SetStatusbar(StatusBarIcon icon, String message);
    }
    ...
    public class Misc
    {
        ...
        /// </summary>
        public static String KwmQuickStartPath { get { return Base.GetKwmInstallationPath() + "quickstart.pdf"; } }

        /// <summary>
        /// Full path to the user guide document.
        /// </summary>
        public static String KwmUserGuidePath { get { return Base.GetKwmInstallationPath() + "userguide.pdf"; } }
        ...
        /// <summary>
        /// Return the help string to display for the given control. Used
        /// for the user and workspace property dialogs.
        /// </summary>
        public static String GetHelpString(Control c, String expl)
        {
            Debug.Assert(expl != null);
            ...
            {
                return "You cannot change this field: " + c.Tag as String +
                    Environment.NewLine + Environment.NewLine +
                    expl;
            }
        }
            ...
            String SourceFilePath, String DestFilePath, ref String errorMessage)
        {
            ...
            return CopyFiles(S, D, false, true, false, false, true, false, ref errorMessage);
        }
                                    ...
                                    ref String errorMessage)
        {
            ...
            return CopyFiles(S, D, HideUiErrors, SilentOverwrite, RenameDestOnCollision, SimpleProgress, false, LockUI, ref errorMessage);
        }
        ...
        public static ShellFileOperation.CopyFileResult CopyFiles(List<String> Sources, List<String> Destinations, bool HideUiErrors, bool SilentOverwrite, bool RenameDestOnCollision, bool SimpleProgress, bool Silent, bool LockUI, ref String errorMessage)
        {
            // Prepare the Shell.
        ...
        public static Exception HandleUnexpectedKAnpReply(String command, AnpMsg msg)
        {
            try
            {
                ...
                {
                    if (msg.Elements[0].UInt32 == KAnpType.KANP_RES_FAIL_RESOURCE_QUOTA)
                        return new LicenseRestrictionException(msg.Elements[1].String, msg.Elements[2].UInt32);
                    else
