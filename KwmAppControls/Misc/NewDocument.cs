    ...
    public class NewDocument
    {
        ...
        public void DoVerbAction(String destination, String param)
        {
            ...
            else if (Verbs.ContainsKey(VerbType.FileName))
            {
                ...
                String errorMsg = "";
                if (Misc.CopyFile(sourceFile, destination + param, true, true, false, true, false, ref errorMsg) == ShellLib.ShellFileOperation.CopyFileResult.Failed)
                    throw new Exception("could not create new file: " + errorMsg);
            }
