...
namespace kwm
{
    ...
    public class KwsStateMachine
    {
        ...
        /// <summary>
        /// Current delete on server step, if any.
        /// </summary>
        private KwsDeleteOnServerStep m_deleteOnServerStep = KwsDeleteOnServerStep.ConnectedAndLoggedOut;
        ...
        private void CheckInvariants()
        {
            ...
            Debug.Assert((m_currentTask != KwsTask.Remove) ^ (m_kws.InKwsRemoveTree()));
        ...
        private bool WantKasConnected()
        {
            return (m_currentTask == KwsTask.WorkOnline ||
                    ...
                    m_currentTask == KwsTask.DeleteOnServer);
        }
        ...
        private bool WantLogin()
        {
            return (m_currentTask == KwsTask.WorkOnline ||
                    ...
                    m_currentTask == KwsTask.DeleteOnServer && m_deleteOnServerStep >= KwsDeleteOnServerStep.Login);
        }
        ...
        {
            // Notify the WM that the workspace can be removed.
            if (m_kws.RefCount == 0 && m_currentTask == KwsTask.Remove)
        ...
        public bool TryStop()
        {
            if (m_currentTask != KwsTask.Stop && m_currentTask != KwsTask.Remove) RequestTaskSwitch(KwsTask.Stop);
        ...
        {
            return (m_currentTask == KwsTask.Remove &&
        ...
        public void HandleAnpEvent(AnpMsg msg)
        {
            ...
            // for a future KWS state machine run.
            if (msg.ID == 0 || m_kws.KAnpState.NbUnprocessedEvent == 1) DispatchAnpEvent(msg);
        }
        ...
        public bool CanStop()
        {
            return (m_currentTask != KwsTask.Remove && m_currentTask != KwsTask.Stop);
        }
        ...
        public bool CanWorkOffline()
        {
            return (m_kws.MainStatus == KwsMainStatus.Good &&
                    m_currentTask != KwsTask.WorkOffline &&
                    m_currentTask != KwsTask.DeleteOnServer);
        }
        ...
        /// <summary>
        /// Return true if the workspace can be requested to be removed.
        /// </summary>
        ...
        /// server.
        /// </summary>
        public bool CanDeleteOnServer()
        {
            return (m_kws.MainStatus != KwsMainStatus.OnTheWayOut &&
                    m_currentTask != KwsTask.DeleteOnServer &&
                    m_currentTask != KwsTask.Remove);
        }
        ...
        {
            return (m_currentTask != KwsTask.DeleteOnServer && 
                    (m_kws.MainStatus == KwsMainStatus.Good || m_kws.MainStatus == KwsMainStatus.RebuildRequired));
        }
        ...
        /// </summary>
        public KwsDeleteOnServerStep GetDeleteOnServerStep()
        {
            return m_deleteOnServerStep;
        }
