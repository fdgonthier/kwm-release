...
namespace kwm
{
    ...
    public partial class Workspace : IAppHelper, ISerializable
    {
        ...
        public KwsUser KwmUser { get { return CoreData.UserInfo.KwmUser; } }

        public KwsUser KwsCreator { get { return CoreData.UserInfo.Creator; } }

        public bool IsCreatorKwmUser { get { return KwmUser.UserID == KwsCreator.UserID; } }
        ...
        {
            info.AddValue("WorkspaceVersion", Misc.SerializationVersion); 
        ...
        {
            return m_wm.KwsRemoveTree.ContainsKey(InternalID);
        }
        ...
        {
            if (!InKwsRemoveTree()) m_wm.KwsRemoveTree[InternalID] = this;
        }
        ...
        {
            if (InKwsRemoveTree()) m_wm.KwsRemoveTree.Remove(InternalID);
        }
        ...
        {
            return CoreData.UserInfo.GetUserByID(ID);
        }

        public KwsUser GetNonVirtualUserByID(UInt32 ID)
        {
            return CoreData.UserInfo.GetNonVirtualUserByID(ID);
        }
        ...
        {
            (new KwsServerDeleteOp(m_wm)).StartOp(this);
        }
        ...
        public UInt64 KwsLoginLatestEventId
        {
            get { return KAnpState.LoginLatestEventId; }
        }
    ...
    public class ExportedKws
    {
        ...
        /// </summary>
        public UInt32 ExportedVersion = KwsCredentials.ExportVersion;
