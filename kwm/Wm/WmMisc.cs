...
namespace kwm
{
    ...
    {
        /// <summary>
        /// Address of freemium KPS
        /// </summary>
        public String FreemiumKpsAddr;
        ...
        /// <summary>
        /// True if the configuration wizard must skip the registration
        /// page and go directly to the sign-in page. Usefull when a customer
        /// wants to deploy the KWM on-site.
        /// </summary>
        ...
        public void Clear()
        {
            ...
            SkipRegistrationFlag = false;
        }

        /// <summary>
        /// Read the values of this instance from the CU registry key.
        /// </summary>
        public void ReadRegistry()
        {
            ...
            try
            {
                ...
                FreemiumKpsAddr = (String)regKey.GetValue("FreemiumKPSAddr", "");
                ...
                SkipRegistrationFlag = ((Int32)regKey.GetValue("SkipRegistration", 0) > 0);
            }
